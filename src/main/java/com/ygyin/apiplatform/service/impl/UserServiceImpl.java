...
import static com.ygyin.apiplatform.constant.UserConstant.USER_LOGIN_STATE;
...
import com.ygyin.apiplatform.model.dto.user.UserQueryRequest;
import com.ygyin.apiplatform.model.enums.UserRoleEnum;
...
import com.ygyin.apiplatform.utils.SqlUtils;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "ygyin";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            // 3. 插入数据前先给用户分配 ak 和 sk
            String ak = DigestUtil.md5Hex(SALT + userPassword + RandomUtil.randomNumbers(3));
            String sk = DigestUtil.md5Hex(SALT + userPassword + RandomUtil.randomNumbers(5));
            // 4. 插入数据
            User user = new User();
